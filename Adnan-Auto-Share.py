...
#os.system('https://www.faceb#ook.com/profile.php?id=100006128411641&mibextid=ZbWKwL')
...
━━━━━━━━━━━━━━━━𝑨𝒅𝒏𝒂𝒏_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━━━━━━━━━━━━━━━
    ...
    ║\33[0;41m          [ JOIN MY T/L GC & SCRIPT GFT  \033[0;92m]
    ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
    \33[1;32m====================================================
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;92mADNAN AHMED
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;93mADNAN AHMED
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TELEGRAM  \033[1;91m : \033[1;94mTERMUX SCRIPT GIFT
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mFB AUTO SHARE 
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;91mFUCK999
     \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TIKTOK \033[1;91m :  \033[1;91mADNANAHMED.499
    \33[1;32m====================================================
    """)
    cetak(nel(f'\n \t {H2}  ADNAN  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} A{K2}D{K2}N{K2}A{K2}N{K2}🌺 {H2}]~',
...
{B2} Current Date    :{H2} {hari}, {tanggal}''', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',
              subtitle_align='left', padding=1, style='blue'))
    cetak(
        nel(f'{K2}Hai {H2}{nama},{K2} 𝑨𝑷𝑵𝑰 𝑱𝑬 𝑰𝑫 𝑻𝑬𝑲𝑬 𝑪𝑶𝑶𝑲𝑰𝑬𝑺 𝑵𝑰𝑺𝑬𝑵 𝑬𝑻𝑨 𝑬𝑲𝑻𝑼 𝑷𝑶𝑹 𝑺𝑼𝑺𝑷𝑬𝑵𝑫𝑬𝑫 𝑯𝑶𝒀𝑬 𝒁𝑨𝑩𝑬 𝑺𝑶 𝑪𝑨𝑹𝑬 𝑭𝑼𝑳𝑳 {M2}!!\n \t\t {N2} 𝑬𝑻𝑨 𝑯𝑶𝑪𝑪𝑬 𝑩𝑶𝑻 𝑺𝑯𝑨𝑹𝑬.',
    ...
    cetak(
        nel(f'{H2} A{H2}D{H2}N{H2}A{H2}N{H2}_ {B2}F{B2}B {O2}A{O2}U{O2}T{O2}O {N2}S{N2}H{N2}A{N2}R{N2}E {K2}S{K2}T{K2}A{K2}R{K2}T',
    ...
    try:
        ...
        for x in range(jumlah):
            ...
            if "id" in post:
                ...
                print(f'{P}\r   └──>{H} {bas} {K} 𝐀{K}𝐝{K}𝐧{K}𝐚{K}𝐧{K} {H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',
                      end='');
                sys.stdout.flush()
            else:
                print("\n")
